...
// configuration step. It creates a namespace called `rt_logger`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", rt_logger::cmake::project_name, rt_logger::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", rt_logger::cmake::project_version);
      return EXIT_SUCCESS;
    }
